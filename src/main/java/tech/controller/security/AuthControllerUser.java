...
public class AuthControllerUser {
    ...
    public AuthControllerUser(AuthenticationManager authenticationManager, TokenService tokenService) {
    ...
    public ResponseEntity<?> login(@RequestBody @Valid LoginRequest request) {
        try {
            ...
            return ResponseEntity.ok(new TokenResponse(userLogado.getId(), usuario, tokenJwt, role));
        } catch (Exception e) {
